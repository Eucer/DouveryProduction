...
class _RecomendProductState extends State<RecomendProduct> {
  ...
  Widget build(BuildContext context) {
    final productCart = context.watch<UserProvider>().user.viewed[widget.index];
    ...
    return Column(
      children: [
        GestureDetector(
          ...
          child: Container(
            margin: EdgeInsets.only(top: 0, right: 8, bottom: 0, left: 10),
            padding:
                        ...
                        children: [
                          ...
                          Container(
                            decoration: BoxDecoration(
                              ...
                              color: const Color.fromARGB(255, 4, 161, 17),
                            ),
